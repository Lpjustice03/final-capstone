...
<div class= "list-of-cards">
    <!-- <div id="list-of-cards" class="container"> -->
    ...
    <!-- <ul class="flashcard-list">
        <li v-on:click="toggleCard(card)" v-for="card in this.$store.state.cards" v-bind:key="card.id" class="card">
    ...
    <div v-for="card in this.$store.state.cards" v-bind:key="card.id" class="card">
